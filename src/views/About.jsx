...
import ab1 from '../assets/images/about/about-1.jpg';
import ab2 from '../assets/images/about/about-2.jpg';
import ab3 from '../assets/images/about/about-3.jpg';
import ab4 from '../assets/images/about/about-4.jpg';
import ab_1 from '../assets/images/about/1.png';
import ab_2 from '../assets/images/about/2.png';
import ab_3 from '../assets/images/about/3.png';
import ab_4 from '../assets/images/about/4.png';
import ab_5 from '../assets/images/about/5.png';
import ab_6 from '../assets/images/about/6.png';
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src={ab1} alt="" class="img-fluid w-100" />
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src={ab2} alt="" class="img-fluid w-100" />
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src={ab3} alt="" class="img-fluid w-100" />
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					<img src={ab4} alt="" class="img-fluid w-100" />
			...
			<div class="col-lg-8">
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_3} alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_4} alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_1} alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_2} alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_5} alt="" class="img-fluid" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src={ab_6} alt="" class="img-fluid" />
						</div>
					</div>
				</div>
			</div>
